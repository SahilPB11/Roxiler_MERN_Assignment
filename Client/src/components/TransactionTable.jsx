...
const TransactionTable = ({ transactions }) => {
    ...
    const handleSearch = async () => {
        const { data } = await axios.get(`http://localhost:5000/api/transactions/list?month=03&search=${search}&page=${page}`);
    ...
    return (
        <div className="mb-4">
            <div className="flex mb-4">
                ...
                <button onClick={handleClearSearch} className="ml-2 p-2 bg-gray-500 text-white rounded-md">Clear</button>
            </div>
